...
$clasificacion="TRAMITES";
$seleccion_archivos_formato=pg_query($conexion,"SELECT * FROM schema_academica.ruta_archivo WHERE (estado=1 AND (pantalla_destino like '%$pantalla_destino%'))")or die('Erro consulta archivos inscripciones: ' . pg_last_error());
...
<section class="container mt-2 pt-2 ">
  <div class="row">
  <h1 class="display-4 text-danger">Formatos</h1>
</div>
...
{?>
  <a class="btn btn-lg btn-outline-warning btn-block letra_btn" href="<?php echo $fila_objetos_enlaces->enlace; ?>"  target="_blank"  ><i class="fa fa-file-pdf-o"></i> <?php echo $fila_objetos_enlaces->nombre_sitio;?> 
</a>
<?php } ?>
