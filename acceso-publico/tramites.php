...
$pantalla_destino="TRAMITES";
$clasificacion="ARCHIVOS";
$seleccion_archivos_formato=pg_query($conexion,"SELECT * FROM schema_academica.ruta_archivo WHERE (estado=1 AND (pantalla_destino='$pantalla_destino' AND descripcion like '%$clasificacion[0]%'))")or die('Erro consulta archivos inscripciones: ' . pg_last_error());
...
<section class="container mt-2 pt-2 ">
  <div class="row">
  <h1 class="display-4 text-danger">Tramites</h1>
</div>
